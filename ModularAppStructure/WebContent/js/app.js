(function (window) {
    ...
    jQuery.sap.declare('demo.app');

    var oAppModel           = null;
    var oResourceBundle     = null;
    var sBasePath           = window.location.pathname.replace(/\/[^\/]*\.?[^\/]*$/, '/');            // in this demo ==> /demo/sapui5/shell/ShellRouterDemo/
    var sBaseUrl            = window.location.protocol + '//' + window.location.host + sBasePath;
    var sResourceBundlePath = sBaseUrl + "i18n/messages.properties";
    var sAppRouterName      = "demoAppRouter";
    ...
    app.init = function () {
        ...
        var oI18nModel = new sap.ui.model.resource.ResourceModel({ bundleUrl: sResourceBundlePath });
        ...
        var view = sap.ui.view({ id: "shellMainView", viewName: "js.modules.Main", type: sap.ui.core.mvc.ViewType.JS });
